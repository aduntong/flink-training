...
public class DataGenerator {
    ...
    public BigDecimal tipBigDecimal() {
        return bigDecimalLong(0L, 60L, 10F, 15F);
    }
    ...
    public BigDecimal tollsBigDecimal() {
        return (rideId % 10 == 0) ? bigDecimalLong(0L, 5L) : BigDecimal.ZERO;
    }
    ...
    public BigDecimal totalFareBigDecimal() {
        return new BigDecimal (3.0 + (1.0 * rideDurationMinutes())).add(tipBigDecimal()).add(tollsBigDecimal());
    }
    ...
    private BigDecimal bigDecimalLong(long min, long max) {
        return new BigDecimal(aLong(min, max));
    }

    private BigDecimal bigDecimalLong(long min, long max, float mean, float stddev) {
        return new BigDecimal(aLong(min, max, mean, stddev));
    }
    // -------------------------------------
